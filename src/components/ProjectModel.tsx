        ...
        <>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4">
            ...
            >
              ...
              <div className="modal-scrollable-content overflow-y-auto overflow-x-hidden h-full max-h-full sm:h-full sm:max-h-full md:h-full md:max-h-full lg:h-full lg:max-h-full
                max-h-[calc(100vh-2rem)] sm:max-h-full"
                style={{
                  // On mobile, set maxHeight to 100vh minus some padding for better scroll
